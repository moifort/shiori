...
- subgenres : de 0 à 3 sous-genres libres qui précisent le genre (« dark fantasy », « space opera », « shōnen », « jeunesse »), chacun écrit en français (fr) ET en anglais (en), telle qu'un libraire de chaque pays l'écrirait ; garde le terme d'origine quand c'est l'usage dans l'autre langue (« LitRPG »). Ce champ fait exception à la règle de langue ci-dessous. Classe-les du plus représentatif au moins représentatif : le premier doit être celui qui décrit le mieux ce livre, car c'est le seul que le lecteur verra dans sa liste. Ne répète pas le genre.
