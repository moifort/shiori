...
import { titleCaseSubgenres } from '~/system/migration/migrations/002-title-case-subgenres'
...
export const migrations: Migration[] = [correctAudibleGenres, titleCaseSubgenres]
